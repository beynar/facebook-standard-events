declare namespace FB_STANDARDS_EVENTS {
  export type EVENTS =
    ...
    | "SUBMIT_APPLICATION" /** When a person applies for a product, service, or program you offer. */
  ...
  export type COMPLETE_REGISTRATION = {
    /** Name of the page/product. */
    content_name: string;
  ...
  export type Params<T extends FB_STANDARDS_EVENTS.EVENTS> = T extends "ADD_TO_CART"
    ? FB_STANDARDS_EVENTS.ADD_TO_CART
    : T extends "ADD_TO_WISHLIST"
    ? FB_STANDARDS_EVENTS.ADD_TO_WISHLIST
    : T extends "COMPLETE_REGISTRATION"
    ? FB_STANDARDS_EVENTS.COMPLETE_REGISTRATION
    : T extends "INITIATE_CHECKOUT"
    ? FB_STANDARDS_EVENTS.INITIATE_CHECKOUT
    : T extends "LEAD"
    ? FB_STANDARDS_EVENTS.LEAD
    : T extends "PURCHASE"
    ? FB_STANDARDS_EVENTS.PURCHASE
    : T extends "SEARCH"
    ? FB_STANDARDS_EVENTS.SEARCH
    : T extends "START_TRIAL"
    ? FB_STANDARDS_EVENTS.START_TRIAL
    : T extends "SUBSCRIBE"
